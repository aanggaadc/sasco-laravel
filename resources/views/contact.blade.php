...
@section('content')
    @if (session()->has('success'))
        <div class="fixed left-0 top-[50px] z-[1] w-full md:top-[120px]">
            <div
                class="relative mx-auto mb-3 mt-3 flex max-w-[500px] flex-col rounded-md bg-gray-200 py-5 pl-6 pr-8 shadow dark:bg-green-700 sm:flex-row sm:items-center sm:pr-6">
